...
namespace GoldPocket.Migrations
{
    ...
    [Migration("20211224163546_total_to_expenseItem")]
    partial class total_to_expenseItem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoldPocket.Models.DB.itemPriceDb", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GoldPocket.Models.DB.itemPriceDb", b =>
                {
                    ...
                    b.HasOne("GoldPocket.Models.DB.expenseItemDb", "expenseItem")
                        .WithOne("itemPrice")
                        .HasForeignKey("GoldPocket.Models.DB.itemPriceDb", "expenseItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
